import React, {cloneElement, type CSSProperties, isValidElement, type ReactElement, type ReactHTMLElement} from 'react';
...
export function Tag(props: TagProps) {
  ...
  if (onDelete) {
    ...
    delIcon = deleteIcon && isValidElement(deleteIcon) ? cloneElement(deleteIcon as ReactHTMLElement<HTMLElement>, {
      ...
      <svg ref={el => addAttribution(el)} xmlns={'http://www.w3.org/2000/svg'} viewBox={'0 0 384 512'} onClick={handleDelete} className={cls([styles.delIcon, styles[size]])} fill={iconColor}>
