...
This package is inspired by and adopts smaller parts of some of the most popular packages, like
[Material UI](https://mui.com/) and [shadcn/ui](https://ui.shadcn.com/). 
